window.I18n = (() => {
  ...
  const MESSAGES = {
    en: {
      ...
      masterDataChangeDuplicateEmail: "This email is already used by another partner.",
      ...
      adminMdrSub:
        "Review proposed partner profile changes. Approving applies the submitted values automatically; rejecting closes the request without changes.",
      ...
      adminMdrLegacyApproveBlocked:
        "This older text-only request cannot be approved automatically. Reject it and ask the partner to submit a new form-based request.",
    ...
    de: {
      ...
      masterDataChangeDuplicateEmail:
        "Diese E-Mail wird bereits von einem anderen Partner verwendet.",
      ...
      adminMdrSub:
        "Vorgeschlagene Partner-Profiländerungen prüfen. Genehmigen übernimmt die Werte automatisch; Ablehnen schließt die Anfrage ohne Änderung.",
      ...
      adminMdrLegacyApproveBlocked:
        "Diese ältere Textanfrage kann nicht automatisch genehmigt werden. Ablehnen und den Partner bitten, eine neue Formular-Anfrage zu senden.",
