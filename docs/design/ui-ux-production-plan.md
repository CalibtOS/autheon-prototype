...
## 10. Vehicle Domain Restructure — Implementation Plan (2026-07-26, PRD v2.7)

Driven by the client confirmation **“Systemlogik Fahrzeugeingabe”**. Business/data spec: `prd.json` v2.7 + `docs/archive/2026-07/prd-changelog-since-2026-07-26.md`. Visual contract: [`design-direction-board-remediation.md`](design-direction-board-remediation.md) “Vehicle domain restructure (V1–V6)”. Previous-state audit: [`design-direction-board-audit.md`](design-direction-board-audit.md) “v1.3 addendum”.
