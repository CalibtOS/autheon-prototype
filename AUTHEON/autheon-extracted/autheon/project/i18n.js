window.I18n = (() => {
  ...
  const MESSAGES = {
    en: {
      ...
      masterDataChangeSubmit: "Send request to dispatch",
      masterDataChangeSent: "Request sent to dispatch.",
    ...
    de: {
      ...
      masterDataChangeSubmit: "Anfrage an Disposition senden",
      masterDataChangeSent: "Anfrage an die Disposition gesendet.",
