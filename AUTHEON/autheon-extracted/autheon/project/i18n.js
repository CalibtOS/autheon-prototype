  ...
  const MESSAGES = {
    en: {
      ...
      statusExplain: {
        ...
        assigned:
          "Dispatcher assigned a partner from Draft (direct dispatch). Active execution with the same performed, Report Problem, and cancel rules as Accepted.",
        accepted:
          "Partner accepted a Published marketplace offer. Active execution alongside Assigned.",
        performed:
          "Partner marked the vehicle transfer finished. Operational completion; documents and settlement are tracked separately.",
        special_case:
          "Partner reported the tour as not performable. Dispatch decides next steps; the tour is not automatically cancelled.",
        cancelled:
          "Tour was cancelled by dispatch or by the partner via Report Problem. Removed from marketplace and active lists.",
      },
      themeLight: "Light",
      themeDark: "Dark",
      ...
      adminInfopointDesc:
        "Publish general documents and short messages for service partners. Drivers see them under Infopoint — not in tour notifications or the marketplace alert bell.",
      ...
      reportCancelPartnerUnavailable: "Service partner unavailable",
      ...
      reportProblemCancelBindingWarning:
        "You are about to cancel this order bindingly. Cancellation after acceptance may trigger costs or further consequences under the applicable partner terms. Please check your decision carefully.",
      reportProblemCancelTermsIntro: "The current service partner terms apply.",
      ...
      masterDataChangePlaceholder:
        "Describe what should be updated (min. 10 characters)…",
      masterDataChangeSubmit: "Send request to operations",
      masterDataChangeSent: "Request sent to the operations team.",
      masterDataChangeTooShort: "Please enter at least 10 characters.",
      ...
      adminMdrSub:
        "Review driver requests to update company, address, email, or phone. Approve or reject, then edit the partner record under Users if needed.",
      ...
      adminMdrDriverNote: "Driver request",
      adminMdrSnapshot: "Data at time of request",
      adminMdrCurrentRecordHint: "Update the live record under Users after approval.",
      adminMdrAdminNote: "Resolution note (optional)",
      adminMdrAdminNotePh: "Note to the driver, e.g. what was changed or why rejected…",
      adminMdrEditSection: "Edit partner master data",
      adminMdrEditSectionHint:
        "Update the fields below, then use Approve & save to apply changes and close the request.",
      adminMdrEditSectionReadonly: "Partner record as stored after resolution.",
      adminMdrSaveDriver: "Save partner data",
      adminMdrSavedDriver: "Partner data saved",
      adminMdrSaveFailed: "Could not save partner data",
      adminMdrApproveHint:
        "Approve & save applies the form (name and company required) and closes the request. Reject closes without saving.",
      adminMdrApprove: "Approve & save",
      adminMdrReject: "Reject request",
      adminMdrResolvedAt: "Resolved",
      adminMdrApprovedToast: "Request approved",
      ...
      adminInvoiceRegisterHint:
        "Use when a partner sends a document outside the PWA (e.g. bundled invoice by email). Upload PDF or images (JPEG, PNG, WebP, GIF).",
      ...
      adminFinanceColPartnerOffer: "Partner offer",
      ...
      adminUsersFieldPartnerId: "Partner ID",
      ...
      newOrderPhonePh: "+49 …",
      newOrderPartnerOfferEur: "Partner offer (EUR) *",
      newOrderPartnerOfferPh: "0.00 €",
      ...
      returnReasonFormalSub: "Creates a special case for dispatch",
      ...
      masterDataChangeNotice:
        "Profile and company details can only be changed by the operations team. Submit a change request below.",
      ...
      adminNotifReportProblemCancel: "Order cancelled by service partner",
    ...
    de: {
      ...
      statusExplain: {
        ...
        assigned:
          "Disposition hat einen Partner aus dem Entwurf zugewiesen (Direktdispatch). Aktive Ausführung mit denselben Regeln für Durchgeführt, Problem melden und Storno wie Akzeptiert.",
        accepted:
          "Partner hat ein veröffentlichtes Marktplatzangebot angenommen. Aktive Ausführung parallel zu Zugewiesen.",
        performed:
          "Partner hat die Fahrzeugübernahme abgeschlossen. Operativer Abschluss; Dokumente und Abrechnung werden separat geführt.",
        special_case:
          "Partner hat die Tour als nicht durchführbar gemeldet. Disposition entscheidet; die Tour wird nicht automatisch storniert.",
        cancelled:
          "Tour wurde von der Disposition oder vom Partner über Problem melden storniert. Aus Marktplatz und aktiven Listen entfernt.",
      },
      themeLight: "Hell",
      themeDark: "Dunkel",
      ...
      navInfopoint: "Infopoint",
      adminInfopointDesc:
        "Allgemeine Dokumente und kurze Nachrichten für Servicepartner veröffentlichen. Fahrer sehen sie unter Infopoint — nicht in Tour-Benachrichtigungen oder der Marktplatz-Glocke.",
      ...
      reportCancelPartnerUnavailable: "Servicepartner nicht verfügbar",
      ...
      reportProblemCancelBindingWarning:
        "Sie stornieren diesen Auftrag verbindlich. Eine Stornierung nach Annahme kann gemäß den Partnerbedingungen Kosten oder weitere Folgen haben. Bitte prüfen Sie Ihre Entscheidung sorgfältig.",
      reportProblemCancelTermsIntro: "Es gelten die aktuellen Servicepartner-Bedingungen.",
      ...
      masterDataChangePlaceholder:
        "Beschreiben Sie die gewünschte Änderung (mind. 10 Zeichen)…",
      masterDataChangeSubmit: "Anfrage an Betrieb senden",
      masterDataChangeSent: "Anfrage wurde an das Betriebsteam gesendet.",
      masterDataChangeTooShort: "Bitte mindestens 10 Zeichen eingeben.",
      ...
      adminMdrSub:
        "Anfragen von Fahrern zu Firma, Adresse, E-Mail oder Telefon prüfen. Genehmigen oder ablehnen, dann ggf. unter Benutzer bearbeiten.",
      ...
      adminMdrDriverNote: "Anfrage des Fahrers",
      adminMdrSnapshot: "Daten zum Zeitpunkt der Anfrage",
      adminMdrCurrentRecordHint: "Live-Datensatz nach Genehmigung unter Benutzer pflegen.",
      adminMdrAdminNote: "Hinweis zur Entscheidung (optional)",
      adminMdrAdminNotePh: "Hinweis an den Fahrer, z. B. was geändert wurde oder warum abgelehnt…",
      adminMdrEditSection: "Partner-Stammdaten bearbeiten",
      adminMdrEditSectionHint:
        "Felder anpassen und mit Genehmigen & speichern übernehmen und die Anfrage schließen.",
      adminMdrEditSectionReadonly: "Partner-Datensatz nach Abschluss der Anfrage.",
      adminMdrSaveDriver: "Partnerdaten speichern",
      adminMdrSavedDriver: "Partnerdaten gespeichert",
      adminMdrSaveFailed: "Partnerdaten konnten nicht gespeichert werden",
      adminMdrApproveHint:
        "Genehmigen & speichern übernimmt das Formular (Name und Firma erforderlich) und schließt die Anfrage. Ablehnen ohne Speichern.",
      adminMdrApprove: "Genehmigen & speichern",
      adminMdrReject: "Anfrage ablehnen",
      adminMdrResolvedAt: "Erledigt",
      adminMdrApprovedToast: "Anfrage genehmigt",
      ...
      adminInvoiceRegisterHint:
        "Wenn der Partner außerhalb der PWA liefert (z. B. Sammelrechnung per E-Mail). PDF oder Bilder (JPEG, PNG, WebP, GIF) hochladen.",
      ...
      adminFinanceColPartnerOffer: "Partnerangebot",
      ...
      newOrderPhonePh: "+49 …",
      newOrderPartnerOfferEur: "Partnerangebot (EUR) *",
      newOrderPartnerOfferPh: "0,00 €",
      ...
      returnReasonFormalSub: "Erzeugt einen Sonderfall für die Disposition",
      ...
      masterDataChangeNotice:
        "Profil- und Firmendaten können nur vom Betriebsteam geändert werden. Senden Sie unten eine Änderungsanfrage.",
      ...
      adminNotifReportProblemCancel: "Auftrag vom Servicepartner storniert",
