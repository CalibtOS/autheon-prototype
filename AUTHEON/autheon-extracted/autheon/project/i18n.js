window.I18n = (() => {
  ...
  const MESSAGES = {
    en: {
      ...
      markCompleted: "Mark as performed",
      ...
      returnWindowClosed: "Report Problem is available",
      ...
      adminOpenPartnerInvoicesBtn: "Partner invoices",
      adminInvoiceReceivedFromProcessed: "From processed partner invoice",
      adminInvoiceReceivedOverrideYes: "Manual override — marked received",
      adminInvoiceReceivedOverrideNo: "Manual override — marked missing",
      adminInvoiceReceivedPending:
        "{count} upload(s) pending — mark processed in Partner invoices",
      adminInvoiceReceivedNone: "No partner invoice linked yet",
      ...
      adminFinanceOpenPartnerInvoicesLink: "Open partner invoices for this tour",
      ...
      adminFinanceTableInvoiceVia: "via partner invoice",
      ...
      returnDeadlineNote: "Report Problem remains available after commitment ({deadline}){closed}",
      closedSuffix: " · closed",
      ...
      returnsIncidents: "Problems & incidents",
      returnsIncidentsSub: "When to cancel or create a special case",
    ...
    de: {
      ...
      markCompleted: "Als durchgeführt markieren",
      ...
      returnWindowClosed: "Problem melden verfügbar",
      profileTitle: "Profil",
      infoTitle: "Info",
      ...
      adminOpenPartnerInvoicesBtn: "Partnerrechnungen",
      adminInvoiceReceivedFromProcessed: "Aus verarbeiteter Partnerrechnung",
      adminInvoiceReceivedOverrideYes: "Manuell — als eingegangen markiert",
      adminInvoiceReceivedOverrideNo: "Manuell — als fehlend markiert",
      adminInvoiceReceivedPending:
        "{count} Upload(s) ausstehend — in Partnerrechnungen als verarbeitet markieren",
      adminInvoiceReceivedNone: "Noch keine Partnerrechnung verknüpft",
      ...
      adminFinanceOpenPartnerInvoicesLink:
        "Partnerrechnungen für diese Tour öffnen",
      ...
      adminFinanceTableInvoiceVia: "über Partnerrechnung",
      ...
      returnDeadlineNote: "Problem melden bleibt nach Annahme verfügbar ({deadline}){closed}",
      ...
      returnsIncidents: "Probleme & Vorfälle",
      returnsIncidentsSub: "Wann storniert oder ein Sonderfall erstellt wird",
