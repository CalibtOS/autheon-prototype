...
const Ic = {
  ...
  X: () => <svg width="12" height="12" viewBox="0 0 24 24" fill="none"><path d="M5 5l14 14M19 5L5 19" stroke="currentColor" strokeWidth="2" strokeLinecap="round"/></svg>,
  Chev: () => <svg width="14" height="14" viewBox="0 0 24 24" fill="none"><path d="M9 6l6 6-6 6" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"/></svg>,
  Back: () => <svg width="16" height="16" viewBox="0 0 24 24" fill="none"><path d="M15 6l-6 6 6 6" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"/></svg>,
  Phone: () => <svg width="13" height="13" viewBox="0 0 24 24" fill="none"><path d="M5 4h4l2 5-2.5 1.5a11 11 0 0 0 5 5L15 13l5 2v4a2 2 0 0 1-2 2A14 14 0 0 1 4 6a2 2 0 0 1 1-2z" stroke="currentColor" strokeWidth="1.6" strokeLinejoin="round"/></svg>,
  Down: () => <svg width="14" height="14" viewBox="0 0 24 24" fill="none"><path d="M12 5v14M5 12l7 7 7-7" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"/></svg>,
  Calendar: () => <svg width="14" height="14" viewBox="0 0 24 24" fill="none"><rect x="3" y="5" width="18" height="16" rx="2" stroke="currentColor" strokeWidth="1.6"/><path d="M3 9h18M8 3v4M16 3v4" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round"/></svg>,
  ...
  Sort: () => <svg width="13" height="13" viewBox="0 0 24 24" fill="none"><path d="M7 5v14M3 15l4 4 4-4M17 19V5M21 9l-4-4-4 4" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"/></svg>,
  Tab: ({on}) => (
  ...
  TabList: ({on}) => (
    <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
      <path d="M4 6h16M4 12h16M4 18h10" stroke="currentColor" strokeWidth={on ? 2.2 : 1.6} strokeLinecap="round"/>
    </svg>
  ),
  TabInfo: ({on}) => (
    <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
      <circle cx="12" cy="12" r="9" stroke="currentColor" strokeWidth={on ? 2 : 1.6}/>
      <path d="M12 11v5M12 8v.5" stroke="currentColor" strokeWidth={on ? 2.2 : 1.8} strokeLinecap="round"/>
    </svg>
  ),
  TabUser: ({on}) => (
    <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
      <circle cx="12" cy="9" r="3.5" stroke="currentColor" strokeWidth={on ? 2 : 1.6}/>
      <path d="M5 20c1.5-3.5 4-5 7-5s5.5 1.5 7 5" stroke="currentColor" strokeWidth={on ? 2 : 1.6} strokeLinecap="round"/>
    </svg>
  ),
  Pdf: () => <svg width="22" height="26" viewBox="0 0 22 26" fill="none"><path d="M3 1h11l5 5v18a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1z" stroke="currentColor" strokeWidth="1.4"/><text x="11" y="20" textAnchor="middle" fontSize="6.5" fontFamily="JetBrains Mono" fontWeight="700" fill="currentColor">PDF</text></svg>,
  Eye: () => <svg width="14" height="14" viewBox="0 0 24 24" fill="none"><path d="M2 12s4-7 10-7 10 7 10 7-4 7-10 7S2 12 2 12z" stroke="currentColor" strokeWidth="1.6"/><circle cx="12" cy="12" r="3" stroke="currentColor" strokeWidth="1.6"/></svg>,
  Pkg: () => <svg width="14" height="14" viewBox="0 0 24 24" fill="none"><path d="M3 7l9-4 9 4-9 4-9-4z" stroke="currentColor" strokeWidth="1.5"/><path d="M3 7v10l9 4 9-4V7M12 11v10" stroke="currentColor" strokeWidth="1.5"/></svg>,
  Refresh: () => <svg width="13" height="13" viewBox="0 0 24 24" fill="none"><path d="M21 12a9 9 0 1 1-3-6.7" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round"/><path d="M21 4v5h-5" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"/></svg>,
  Logout: () => <svg width="14" height="14" viewBox="0 0 24 24" fill="none"><path d="M9 4H5a1 1 0 0 0-1 1v14a1 1 0 0 0 1 1h4M14 8l4 4-4 4M18 12H8" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"/></svg>,
  N: {
    Tour: () => <svg width="14" height="14" viewBox="0 0 24 24" fill="none"><path d="M5 17l5-12 4 8 5-4" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"/></svg>,
    Users: () => <svg width="14" height="14" viewBox="0 0 24 24" fill="none"><circle cx="9" cy="9" r="3" stroke="currentColor" strokeWidth="1.5"/><path d="M3 19c0-3 3-5 6-5s6 2 6 5M16 11a3 3 0 1 0 0-6M22 19c0-2.5-2-4-5-4.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/></svg>,
    Building: () => <svg width="14" height="14" viewBox="0 0 24 24" fill="none"><path d="M4 21V5a1 1 0 0 1 1-1h9a1 1 0 0 1 1 1v16M15 21V11h4a1 1 0 0 1 1 1v9M2 21h20M8 8h2M8 12h2M8 16h2" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round"/></svg>,
    Doc: () => <svg width="14" height="14" viewBox="0 0 24 24" fill="none"><path d="M5 3h10l5 5v13H5z" stroke="currentColor" strokeWidth="1.5" strokeLinejoin="round"/><path d="M14 3v6h6" stroke="currentColor" strokeWidth="1.5" strokeLinejoin="round"/></svg>,
    Audit: () => <svg width="14" height="14" viewBox="0 0 24 24" fill="none"><path d="M6 4h8l4 4v12H6z" stroke="currentColor" strokeWidth="1.5"/><path d="M9 11h6M9 15h4" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round"/></svg>,
...
const RouteStack = ({ job, big = true }) => {
  ...
  <div className="route">
    ...
    <div>
      <div>
        <div className="city" style={{ fontSize: big ? 22 : 18 }}>{job.startCity}</div>
        <div className="meta">{job.startPlz} · {t("pickup")}</div>
      </div>
      <div className="end">
        <div className="city" style={{ fontSize: big ? 22 : 18 }}>{job.endCity}</div>
        <div className="meta">{job.endPlz} · {t("destination")} · {job.distanceKm} km</div>
      </div>
    </div>
  </div>
  );
...
const PhoneStatusBar = () => (
  <div className="statusbar">
    ...
    <span className="right">
      <span className="signal"><i style={{height:6}}></i><i style={{height:8}}></i><i style={{height:10}}></i><i style={{height:12}}></i></span>
    ...
    <div className="tabbar">
      {items.map(it => (
        <button key={it.id} className={tab === it.id ? "on" : ""} onClick={() => setTab(it.id)}>
          <span className="tab-icon"><it.I on={tab === it.id} /></span>
          <span>{it.label}</span>
        </button>
      ))}
    </div>
  ...
  return (
    <div className="jobcard" onClick={() => onOpen(job)}>
      ...
      <div style={{ display: "flex", gap: 8, marginTop: 14, flexWrap: "wrap" }}>
        <span className="chip mono"><Ic.Calendar /><span style={{marginLeft:4}}>{job.date}</span></span>
        <span className="chip mono">{job.windowFlex ? t("flexible") : `${job.windowFrom}–${job.windowTo}`}</span>
      </div>
...
const Portal = ({ filters, setFilters, openFilter, onOpenJob }) => {
  ...
  if (!store.isCurrentDriverActive()) {
    ...
    return (
      <div className="scroll" style={{ padding: "24px 22px", background: "var(--paper-2)" }}>
        <h1 style={{ margin: 0, fontSize: 24, fontWeight: 700 }}>{t("blockedDriverTitle")}</h1>
        <div className="card" style={{ padding: 18, marginTop: 18, borderColor: "var(--st-cancelled)" }}>
          <Pill status="cancelled">{d?.status || t("blockedDriverStatusFallback")}</Pill>
          <p style={{ margin: "12px 0 0", fontSize: 13.5, lineHeight: 1.55, color: "var(--muted)" }}>
            {t("blockedDriverBody")}
          </p>
        </div>
      </div>
  ...
  const filtered = all.filter(j => {
    ...
    if (filters.startPlz && String(filters.startPlz).trim()) {
      ...
      if (d.length >= 2 && !String(j.startPlz).startsWith(d.slice(0, 2))) return false;
    }
    if (filters.endPlz && String(filters.endPlz).trim()) {
      const d = String(filters.endPlz).replace(/\D/g, "");
      if (d.length >= 2 && !String(j.endPlz).startsWith(d.slice(0, 2))) return false;
    }
    if (filters.from && String(filters.from).trim() && !["Today", "This week", "Weekend"].includes(filters.from)) {
    ...
    if (filters.from === "Weekend" && !String(j.dateLong || "").match(/Sat|Sun/i)) return false;
    if (filters.vehicle && filters.vehicle !== "All" && j.vehicle !== filters.vehicle) return false;
    if (filters.axle && filters.axle !== "All" && j.axle !== filters.axle) return false;
    return true;
  });
  ...
  return (
    <>
      <div style={{ padding: "8px 22px 18px", borderBottom: "1px solid var(--line)" }}>
        <h1 style={{ margin: 0, fontSize: 24, fontWeight: 700, letterSpacing: "-0.015em" }}>{t("marketplace")}</h1>
        <div className="label" style={{ marginTop: 4 }}>{all.length} {t("openTours")} · {new Date().toLocaleDateString(locale === "de" ? "de-DE" : "en-GB", { weekday: "short", day: "2-digit", month: "short" })}</div>
        <div style={{ display: "flex", gap: 8, marginTop: 14, flexWrap: "wrap" }}>
          <button className={`chip actionable ${activeChips.length ? "on" : ""}`} onClick={openFilter}>
            <Ic.Filter /> {t("filters")}{activeChips.length ? " · " + activeChips.length : ""}
          </button>
          {activeChips.map(c => (
            <span key={c.key} className="chip" onClick={() => setFilters({ ...filters, [c.key]: "" })}>
              {c.label} <span className="x"><Ic.X /></span>
            </span>
          ))}
        </div>
      </div>
      <div className="scroll" style={{ padding: "16px 18px 24px", background: "var(--paper-2)" }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 12 }}>
          <Lbl>{ordered.length} {t("results")}</Lbl>
          <button
            type="button"
        ...
        {ordered.map(j => <JobCard key={j.id} job={j} onOpen={onOpenJob} />)}
        {ordered.length === 0 && (
          <div className="dash-area" style={{ padding: 28, textAlign: "center" }}>
            {t("noToursMatch")}<br />
            <button type="button" className="btn xs" style={{ marginTop: 10 }} onClick={() => setFilters({})}>{t("resetFilters")}</button>
          </div>
        )}
...
const FilterSheet = ({ filters, setFilters, onClose }) => {
  const { t } = useI18n();
  const [local, setLocal] = useState({ vehicle: "All", axle: "All", ...filters });
  const reset = () => setLocal({ startPlz: "", endPlz: "", from: "", to: "", vehicle: "All", axle: "All" });
  ...
  const preview = store.getJobs().filter(j => {
    ...
    if (local.vehicle && local.vehicle !== "All" && j.vehicle !== local.vehicle) return false;
    if (local.axle && local.axle !== "All" && j.axle !== local.axle) return false;
    return true;
  }).length;
      ...
      <div className="sheet" onClick={e => e.stopPropagation()}>
        ...
        <div className="sheet-head">
          ...
          <div style={{ display: "flex", gap: 12, alignItems: "center" }}>
            <button type="button" onClick={reset} className="btn ghost xs" style={{ textDecoration: "underline", textUnderlineOffset: 3 }}>{t("reset")}</button>
            <button type="button" onClick={onClose} className="btn icon sm"><Ic.X /></button>
          </div>
        </div>
        <div className="sheet-body">
          <div className="field-label">{t("postalArea")}</div>
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10 }}>
            <input className="input" placeholder={t("pickupExample")} value={local.startPlz || ""} onChange={e => setLocal({ ...local, startPlz: e.target.value })} />
            <input className="input" placeholder={t("deliveryExample")} value={local.endPlz || ""} onChange={e => setLocal({ ...local, endPlz: e.target.value })} />
          </div>

          <div className="field-label" style={{ marginTop: 18 }}>{t("dateWindow")}</div>
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10 }}>
            <input className="input" placeholder={t("from")} value={local.from || ""} onChange={e => setLocal({ ...local, from: e.target.value })} />
            <input className="input" placeholder={t("until")} value={local.to || ""} onChange={e => setLocal({ ...local, to: e.target.value })} />
          </div>
          <div style={{ display: "flex", gap: 8, marginTop: 10, flexWrap: "wrap" }}>
            {[[t("today"), "Today"], [t("thisWeek"), "This week"], [t("weekend"), "Weekend"]].map(([label, value]) => (
              <span key={value} className={"chip actionable " + (local.from === value ? "on" : "")} style={{cursor:"pointer"}} onClick={() => setLocal({ ...local, from: local.from === value ? "" : value })}>{label}</span>
            ))}
          </div>
        ...
        <div className="sheet-foot">
          ...
          <button type="button" className="btn primary" onClick={() => { setFilters(local); onClose(); }}>{t("showResults", { count: preview })}</button>
        </div>
      </div>
    </div>
  );
  ...
  <>
    <div style={{ padding: "0 18px 14px", borderBottom: "1px solid var(--line)" }}>
      <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
        ...
        <h2 style={{ margin: 0, fontSize: 17, fontWeight: 700 }}>{t("marketplacePreview")}</h2>
      </div>
    </div>
    <div className="scroll" style={{ padding: "16px 18px 22px", background: "var(--paper-2)" }}>
      <div className="card" style={{ padding: 18 }}>
        <Lbl>{t("routeSummary")}</Lbl>
        <div style={{ display: "flex", alignItems: "center", gap: 12, marginTop: 12 }}>
          <span style={{ fontSize: 28, fontWeight: 700, letterSpacing: "-0.02em" }} className="mono">{job.startPlz}</span>
          <span style={{ flex: 1, borderTop: "1.5px dashed var(--line-2)", position: "relative" }}>
            <span style={{ position: "absolute", right: -3, top: -5, width: 9, height: 9, borderRadius: "50%", background: "var(--primary)" }}></span>
          </span>
          <span style={{ fontSize: 28, fontWeight: 700, letterSpacing: "-0.02em" }} className="mono">{job.endPlz}</span>
        </div>
        <div className="label" style={{ marginTop: 8 }}>{job.startCity} → {job.endCity} · {job.distanceKm} km</div>
      </div>
      ...
      <div className="card" style={{ padding: 0, marginTop: 12 }}>
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr" }}>
          ...
          <div style={{ padding: 16 }}>
            ...
            <div style={{ fontWeight: 600, marginTop: 6 }} className="mono">{job.windowFlex ? t("flexible") : `${job.windowFrom} – ${job.windowTo}`}</div>
          </div>
        </div>
        <div style={{ borderTop: "1px solid var(--line)", display: "grid", gridTemplateColumns: "1fr 1fr" }}>
          <div style={{ padding: 16, borderRight: "1px solid var(--line)" }}>
            ...
            <div className="mono" style={{ fontSize: 12, color: "var(--muted)", marginTop: 2 }}>{job.vehicleModel}</div>
          </div>
          <div style={{ padding: 16 }}>
            <Lbl>{t("axle")}</Lbl>
      ...
      <div className="card" style={{ padding: 18, marginTop: 12, display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        <Lbl>{t("payout")}</Lbl>
        <div style={{ fontSize: 28, fontWeight: 700, letterSpacing: "-0.02em" }} className="tnum">€ {job.price.toFixed(2)}</div>
      </div>

      <div className="dash-area" style={{ marginTop: 14, padding: 16 }}>
        <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 12, color: "var(--text)", letterSpacing: 0 }}>
          <span style={{ width: 14, height: 14, border: "1.5px solid var(--primary-ink)", borderRadius: 3, display: "inline-flex", alignItems: "center", justifyContent: "center" }}>
            <Ic.Pkg />
          </span>
          <strong style={{ fontFamily: "var(--font-sans)", fontSize: 13, textTransform: "none", letterSpacing: 0 }}>{t("unlockedAfterAcceptance")}</strong>
        </div>
        <ul style={{ margin: 0, paddingLeft: 22, fontFamily: "var(--font-mono)", fontSize: 11, lineHeight: 1.9, textTransform: "none", letterSpacing: 0.02, color: "var(--muted)" }}>
    ...
    <div style={{ padding: "12px 16px 18px", borderTop: "1px solid var(--line)", display: "grid", gridTemplateColumns: "1fr 1.6fr", gap: 10, background: "var(--paper)" }}>
      <button type="button" className="btn" onClick={onBack}>{t("back")}</button>
      <button type="button" className="btn primary" onClick={onAccept}>{t("acceptTour")}</button>
    </div>
  </>
  );
};
...
const AcceptanceModal = ({ job, onCancel, onConfirm }) => {
  ...
  const onStart = (e) => {
    ...
    const move = (ev) => {
      ...
      const dx = Math.max(0, Math.min(rect.width - 92, startPos + (cx - startX)));
      setPos(dx);
    ...
    <div className="sheet-backdrop center" onClick={onCancel}>
      <div className="sheet modal" onClick={e => e.stopPropagation()} style={{ padding: 24 }}>
        ...
        <div style={{ border: "1px solid var(--line)", borderRadius: "var(--r-2)", padding: 14, background: "var(--paper-2)" }}>
          ...
          <div style={{ fontWeight: 700, fontSize: 16 }} className="mono">{job.startPlz} → {job.endPlz} · {job.distanceKm} km</div>
          <div className="mono" style={{ fontSize: 12, color: "var(--muted)", marginTop: 6 }}>
            {job.dateLong} · {job.windowFlex ? t("flexible") : `${job.windowFrom}–${job.windowTo}`} · {job.vehicle} · {job.axle}
          </div>
          <div style={{ fontSize: 18, fontWeight: 700, marginTop: 10 }} className="tnum">€ {job.price.toFixed(2)}</div>
        </div>
      ...
      <div style={{ marginTop: 18 }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "16px 1fr", gap: 14, marginTop: 10 }}>
          <div style={{ display: "flex", flexDirection: "column", alignItems: "center", paddingTop: 6 }}>
            ...
            <span style={{ flex: 1, width: 1.5, background: "var(--primary)", margin: "4px 0", minHeight: 38 }}></span>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10, marginTop: 8 }}>
        {[[t("pickup"), pickup], [t("delivery"), drop]].map(([k, c]) => (
          <div key={k} className="card flat" style={{ padding: 12 }}>
            ...
            <div style={{ fontWeight: 600, marginTop: 6, fontSize: 14 }}>{c.name || "—"}</div>
            <a href={"tel:" + (c.phone || "").replace(/\s/g,"")} className="mono" style={{ display: "inline-flex", alignItems: "center", gap: 4, fontSize: 12, color: "var(--text)", textDecoration: "underline", textUnderlineOffset: 2, marginTop: 4 }}>
              <Ic.Phone /> {c.phone || "—"}
            </a>
          </div>
        ))}
...
const MyJobs = ({ onOpen }) => {
  ...
  const active = mine.filter((j) => ["assigned", "accepted", "return_requested"].includes(j.status));
  ...
  return (
    <>
      <div style={{ padding: "8px 22px 0" }}>
        <h1 style={{ margin: 0, fontSize: 24, fontWeight: 700, letterSpacing: "-0.015em" }}>{t("myJobs")}</h1>
      </div>
      <div style={{ padding: "16px 22px 0" }}>
        <div className="tabs">
          {[
            ...
            <button key={id} type="button" className={tab === id ? "on" : ""} style={{ cursor: "pointer" }} onClick={() => setTab(id)}>
      ...
      <div className="scroll" style={{ padding: "16px 18px 22px", background: "var(--paper-2)" }}>
        {list.length === 0 && <div className="dash-area" style={{ padding: 28, textAlign: "center" }}>{t("nothingHereYet")}</div>}
        {list.map((job) => (
          <div key={job.id} className="jobcard" onClick={() => onOpen(job)}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr auto", gap: 12 }}>
              ...
              <div style={{ textAlign: "right", fontSize: 19, fontWeight: 700 }} className="tnum">€ {job.price.toFixed(2)}</div>
            </div>
    ...
    <div className="sheet-backdrop" onClick={onClose}>
      <div className="sheet" onClick={e => e.stopPropagation()}>
        ...
        <div className="sheet-foot">
          ...
          <button type="button" className="btn primary" disabled={!valid || closed} onClick={() => onSubmit(reason, text)}>{t("submit")}</button>
        </div>
      </div>
    </div>
  );
...
Object.assign(window, {
  Pill, Lbl, Ic, RouteStack, PhoneStatusBar, TabBar,
  Portal, FilterSheet, JobCard,
  JobLocked, AcceptanceModal, JobUnlocked, MyJobs,
  ReturnSheet, PendingNotice, ProfilePane, InfoPane, ProfilePaneFull, InfoPaneFull,
});
